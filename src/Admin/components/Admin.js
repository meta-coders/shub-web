...
const AdminRouter = ({ match }) => (
  <div>
    <Navbar />
    <Switch>
      <Route exact path={match.url + '/uploadTimetable'} component={TimetablePage} />
      <Route exact path={match.url + '/uploadSchedule'} component={SchedulePage} />
      <Route exact path={match.url + '/uploadStudents'} component={StudentsPage} />
